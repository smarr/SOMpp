...
set grid ytics
plot "benchmark_results/generational_nocache_tagging_richards.csv" using 2:3:xtic(1) ti "Richards generational (tagging)", \
     ...
     "benchmark_results/copying_nocache_tagging_richards.csv" using 2:3 ti "Richards copying (tagging)", \
     "benchmark_results/copying_additional_allocation_richards.csv" using 2:3 ti "Richards copying (additional allocation)", \
     "benchmark_results/mark_sweep_nocache_tagging_richards.csv" using 2:3 ti "Richards mark-sweep (tagging)", \
