...
make clean; make DEST_DIR=bin/generational_additional_allocation GC_TYPE=generational CACHE_INTEGER=false USE_TAGGING=false install -j5
...
make clean; make DEST_DIR=bin/copying_additional_allocation GC_TYPE=copying CACHE_INTEGER=false USE_TAGGING=false install -j5
...
make clean; make DEST_DIR=bin/mark_sweep_additional_allocation GC_TYPE=mark_sweep CACHE_INTEGER=false USE_TAGGING=false install -j5
